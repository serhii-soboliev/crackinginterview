class SurroundedRegions:
    ...
    def solve(self, board) -> None:
        ...
        self.mark_aligned_to_sides_regions(board, sides_os, n, m)

        self.replace_one_symbol_with_another(board, self.O, self.X, n, m)
        self.replace_one_symbol_with_another(board, self.V, self.O, n, m)

    def mark_aligned_to_sides_regions(self, board, sides_os,  n, m):
        bfs_queue = set(sides_os)
        while bfs_queue:
            k, t = bfs_queue.pop()
            board[k][t] = self.V
            bfs_queue |= set(self.get_neighbours(board, k, t, n, m))
