...
class TestGraph(unittest.TestCase):
    ...
    def test_graph_find_longest_acyclic_path(self, name, v, e, v_from, v_to, expected):
        self.assertEqual(Graph(v,e).find_longest_acyclic_path_recursive(v_from, v_to), expected, "Error in test #" + name)
